...
<?php
$collection = \Tainacan\Repositories\Collections::get_instance()->fetch_one(['name' => 'Filme  Cultura'], 'OBJECT');
$items = \Tainacan\Repositories\Items::get_instance()->fetch(['orderby' => 'post_title', 'order' => 'DESC', 'nopaging' => true], $collection);
?>
